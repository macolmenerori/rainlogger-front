...
- **Root**: `app/root.tsx` - i18n initialization (side-effect import), font imports, `App` component (with `ThemeProvider` + `AlertProvider` + `UserProvider` + `<Outlet />`), and re-exports of `Layout` and `ErrorBoundary`
